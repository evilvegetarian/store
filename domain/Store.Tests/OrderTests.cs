...
namespace Store.Tests
{
    public class OrderTests
    {
        ...
        [Fact]
        public void TotalCount_WithEmpthyItems_ReturnZero()
        {
        ...
        [Fact]
        public void TotalPrice_WithEmpthyItems_ReturnZero()
        {
            var order = new Order(1, new OrderItem[0]);
        ...
        [Fact]
        public void TotalCount_WithNonEmpthyItems_CalcualtesTotalCount()
        {
        ...
        [Fact]
        public void TotalPrice_WithNonEmpthyItems_CalcualtesTotalPrice()
        {
            var order = new Order(1, new[]
            {
                new OrderItem(1,3,10m),
